        ...
        <div className="create-temp">
            ...
            <div className="create-temp-header">
                ...
                <div className="temp-title">
                    ...
                    <input type="text" placeholder="Block title goes here" name="temp-title" value=""/>
            ...
            <div className="create-temp-content">
                ...
                <textarea  type="text" rows="4" placeholder="Start typing" name="temp-content" value=""></textarea>
